...
def load_and_preprocess_data(filepath="data/raw/synthetic_bank_fraud.csv"):
    ...
    # 1. Convert text columns (like UPI, IMPS) into ML-readable numbers
    ...
    # Save exact column layout so Suyash and Aryan can load it properly
    ...
    # 5. Apply SMOTE to balance the Digital Arrest threats
